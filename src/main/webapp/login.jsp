		...
		<div class="span12 last">
			<div class="wrap">
				<div class="main">
					...
					<form id="loginForm"
						action="${ pageContext.request.contextPath }/customerAction_login.action"
						...
						<table>
							<tbody>
								...
								<tr>
									<th></th>
									<td><span id="span1"
										style="text-align:center; margin-top:20px; color:red">${map.info}</span></td>
								</tr>
								...
								<tr class="register">
									...
									<td>
										<dl>
											<dt>还没有注册账号？</dt>
											<dd>
												立即注册即可体验在线购物！ <a href="regist.jsp">立即注册</a>
											</dd>
										</dl>
									</td>
								</tr>
